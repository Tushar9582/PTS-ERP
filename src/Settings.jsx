...
const AdminList = () => {
  ...
  const columns = [
    {
      title: <span className={darkMode ? "dark-table-header" : ""}>Avatar</span>,
      dataIndex: "photoURL",
      render: (photoURL) => <Avatar src={photoURL} size={48} />,
      width: 80,
      responsive: ['md']
    },
    {
    ...
    {
      title: <span className={darkMode ? "dark-table-header" : ""}>Actions</span>,
      dataIndex: "actions",
      render: () => (
        <Button icon={<MoreOutlined className={darkMode ? "dark-icon" : ""} />} shape="circle" className={darkMode ? "dark-button" : ""} />
      ),
      width: 80
    },
  ];
        ...
        {isMobile ? (
          ...
          <div className={`mobile-user-card ${darkMode ? "dark-mobile-card" : ""}`}>
            <div className="mobile-user-header">
              <Avatar src={currentUser.photoURL} size={64} />
            ...
            <div className="mobile-actions">
              <Button icon={<MoreOutlined className={darkMode ? "dark-icon" : ""} />} className={darkMode ? "dark-button" : ""}>
                Actions
              </Button>
            </div>
          </div>
