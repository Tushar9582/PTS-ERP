...
const InvoiceCard = () => {
  ...
  const cashFlowStages = [
    { name: 'Draft', value: invoiceData.statusCounts.draft, color: '#8884d8', icon: <FiFileText /> },
    { name: 'Pending', value: invoiceData.statusCounts.pending, color: '#83a6ed', icon: <FiFileText /> },
    { name: 'Paid', value: invoiceData.statusCounts.paid, color: '#8dd1e1', icon: <FiDollarSign /> },
      ...
      <div className="card-grid">
        ...
        <div className={`dashboard-card ${darkMode ? 'dark-card' : ''}`}>
          <div className="card-header">
            ...
            <div className={`card-icon ${darkMode ? 'dark-icon' : ''}`}>
              <FiDollarSign size={18} className={darkMode ? 'text-light' : ''} />
            </div>
          </div>
          <div className={`card-value ${darkMode ? 'text-light' : ''}`}>
            {invoiceData.loading ? '...' : (
